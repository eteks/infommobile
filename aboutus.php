...
<html lang="en">
    ...
    <body data-hijacking="on" data-animation="opacity">
        ...
        <div class="container biograph_desktop hidden-xs">
                            ...
                            <div class="col-md-6 col-sm-6 bio_3_left padding_right_none col-xs-12">
                                <div class="bio_3_left_content">
                                    <div class="container_hex">
                                        <!-- iocd -->
                                        <div class="popup effect-fade-scale" id="popup-dialogiocd">
                                            <div class="popup-content">
                                                <h3>International Organization of Chemical Sciences in development</h3>
                                        ...
                                        <div class="popup-overlay" data-popup-js=""></div>


                                        <!-- Aas-->
                                        <div class="popup effect-fade-scale" id="popup-dialogaas">
                                            <div class="popup-content">
                                                <h3>African Academy of Science</h3>
                                                <div class="content mCustomScrollbar mcusheight" style="height: 200px;">
                                                    <p>
                                        ...
                                        </div><div class="popup-overlay" data-popup-js=""></div>


                                        <!-- bgi-->
                                        <div class="popup effect-fade-scale" id="popup-dialogbgi" style="margin-top: -134px;">
                                            <div class="popup-content">
                                                <h3> Business Gateway International</h3>
                                                <div class="content mCustomScrollbar mcusheight" style="height: 200px;">
                                                    <p>
                                        ...
                                        <!--CENTAC-->
                                        <div class="popup effect-fade-scale" id="popup-dialogcentac">
                                            <div class="popup-content">
                                                <h3> Centralized Admission Committee</h3>
                                                <div class="content mCustomScrollbar mcusheight" style="height: 200px;">
                                                    <p>
                                        ...
                                        <div class="popup effect-fade-scale" id="popup-dialogLAK">
                                            <div class="popup-content">
                                                <h3>Vivekanandha Group of Institutions</h3>
                                                <div class="content mCustomScrollbar mcusheight" style="height: 200px;">
                                                    <p>
                                        ...
                                        <!-- IGA -->
                                        <div class="popup effect-fade-scale" id="popup-dialogiga">
                                            <div class="popup-content">
                                        ...
                                        <!-- Winning minds -->
                                        <div class="popup effect-fade-scale" id="popup-dialogwms">
                                            <div class="popup-content">
                                        ...
                                        <!-- TVR -->
                                        <div class="popup effect-fade-scale" id="popup-dialogtvr">
                                            <div class="popup-content">
                                                <h3>TVR Group</h3>
                                                <div class="content mCustomScrollbar mcusheight" style="height: 200px;">
                                                    <p>
                                        ...
                                        <!-- vali -->
                                        <div class="popup effect-fade-scale" id="popup-dialogvali">
                                            <div class="popup-content">
                                        ...
                                        <!-- Kalai -->
                                        <div class="popup effect-fade-scale" id="popup-dialogk10">
                                            <div class="popup-content">
                                                <h3>Kalaiaruvi -Fine Arts Academy</h3>
                                                <div class="content mCustomScrollbar mcusheight" style="height: 200px;">
                                                    <p>
                                        ...
                                        <div class="popup-overlay" data-popup-js=""></div>
                                        <div class="pic">
                                            <div class="hex pic-image hex-gap" style="background-image: url(images/hexogen/iocd.png);">
                                        ...
                                        <div class="pic">
                                            <div class="hex pic-image" style="background-image: url(images/hexogen/aas.png);">
                                        ...
                                        <div class="pic">
                                            <div class="hex pic-image" style="background-image: url(images/hexogen/bgi.png);">
                                        ...
                                        <div class="pic">
                                            <div class="hex pic-image" style="background-image: url(images/hexogen/centac.png);">
                                        ...
                                        <div class="pic">
                                            <div class="hex pic-image" style="background-image: url(images/hexogen/vivekananda_logo_bw.jpg);">
                                        ...
                                        <div class="pic">
                                            <div class="hex pic-image" style="background-image: url(images/hexogen/iga.png);">
                                        ...
                                        <div class="pic">
                                            <div class="hex pic-image" style="background-image: url(images/hexogen/wms.png);">
                                        ...
                                        <div class="pic">
                                            <div class="hex pic-image hex-gap" style="background-image: url(images/hexogen/tvr.png);">
                                        ...
                                        <div class="pic">
                                            <div class="hex pic-image" style="background-image: url(images/hexogen/vali.png);">
                                        ...
                                        <div class="pic">
                                            <div class="hex pic-image" style="background-image: url(images/hexogen/kalai.png);">
                                    ...
                                    <p style="text-align: right;    position: absolute;    right: 15px;    bottom: 0; color: #c31118; font-style: italic; font-size: 13px; font-family: century gothic;">Click logos to view</p>
                        ...
                        <div class="slide_content">
                            ...
                            <div class="col-md-6 padding_right_none bio_4_left col-xs-12 col-sm-6">
                                <div class="bio_4_left_content">
                                    ...
                                    <ul style="float: left; width: 31%; list-style-type: none; font-style: italic;">
                                        <li>Portals</li>
                                        <li>Cloud based apps</li>
                                        <li>Creative webdesign</li>
                                    </ul>

                                    <ul style="float: left; width: 69%; list-style-type: none; font-style: italic;">
                                        <li>Mobile Apps</li>
                            ...
                            <div class="col-md-6 pn bg_clr col-sm-6">
                                <div class="bio_4_right_content ">
                                    ...
                                    <ul style="list-style-type: none; font-style: italic;padding-left:70px;">
            ...
            <section class="cd-section section4"  id="sec6">
                <div>
                    <div class="biography">
                        <div class="slide_content">
                            <div class="col-md-6 col-xs-12 col-sm-6">
        ...
        <div class="main_wrapper dn container-fluid">
            <header>
                <div class="col-md-12 col-xs-12 header_menu col-sm-12">
                ...
                <div class="bio_menu col-sm-12 col-md-12 col-lg-12 col-xs-12 hidden-xs">
                    ...
                    <ul class="bio_submenu" data-in-effect="bounceInDown">
                        ...
                        <li><a href="#sec2" class="hvr-buzz-out client_act_click">Clients speak</a></li>
