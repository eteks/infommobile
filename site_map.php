...
<html lang="en">
    ...
    <body>
        ...
        <div class="container sitemap_content">
                <div class="col-md-12 clr_font">
                    ...
                    <div class="one">
                        <p class="about">
                            <b>
                                <a href="aboutus.php" target="_blank" class="font_active" >About Us</a>
                            </b>
                        </p>
                        <p class="bio">
                        ...
                        <p class="exp">
                            <a href="aboutus.php" class="expertise-map font_active" target="_blank">Expertise</a>                        </p>
                        <img class="img1" src="images/section1.png">
                        <img class="img2" src="images/line.png">
                ...
                <div class="col-md-12 clr_font">    
                    <div class="two">
                        ...
                        <p class="join"><a href="innovation.php" class="join-map font_active" target="_blank"> Join Our Hub</a></p>
                    </div>
                </div><!--col-md-12-->
                <div class="col-md-12 clr_font">
                    <div class="three">
                        <p class="concepts"><b><a href="concepts2life.php" class="font_active" target="_blank"> Conceptsbrought2life</a></b></p>
                        <img class="img1" src="images/section3.png">
                        <p class="port"><a href="concepts2life.php" class="font_active" target="_blank"> Portfolio</a></p>
                        <p class="ser"><a href="services.php" class="font_active" target="_blank"> Services</a></p>
                        ...
                        <img class="get" src="images/line5.png">
                        <div class="hit">
                            <ul class="list3">
                            <li><a href="products.php#psecondPage" target="_blank" class="font_active"> Cloud Apps</a></li>
                                <ul class="sub_list">
                            ...
                            <li><a href="products.php#p3rdPage" target="_blank" class="font_active">Enterprise Apps</a></li>
                                <ul class="sub_list">
                                <li><a href="products.php#p3rdPage" target="_blank" class="font_active"> ERP for Manufacturing sector</a></li>
                                </ul>
                            <li><a href="products.php#p4thpage" target="_blank" class="font_active"> Desktop Apps</a></li>
                                <ul class="sub_list">
	 ...
	 <div class="container sitemap_content hidden-lg">
                <div class="col-md-12 clr_font">
                    <h4><a href="aboutus.php" target="_blank" class="font_active">About us</a></h4>
                    <div class="col-md-2">
